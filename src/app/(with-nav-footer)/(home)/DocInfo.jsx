const DocInfo = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-white mt-32 px-4 md:px-0">
      <div className="bg-[#07332F] w-full md:w-[364px] h-[202px] rounded-[10px]">
        {/* Time Info: */}
        <div className="flex gap-5 py-[50px] pl-[40px]">
          <svg
          ...
          <div className="">
            <h5 className="text-[25px] font-bold">Opening Hours</h5>
            <p className="text-xl font-normal mb-[10px]">
      ...
      {/* Locations Info: */}
      <div className="bg-[#F7A582] w-full md:w-[364px] h-[202px] rounded-[10px]">
        <div className="flex gap-5 py-[50px] pl-[40px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="50"
          ...
          <div className="">
            <h5 className="text-[25px] font-bold mb-[10px]">Our Locations</h5>
      ...
      <div className="bg-[#07332F] w-full md:w-[364px] h-[202px] rounded-[10px]">
        <div className="flex gap-5 py-[50px] pl-[40px]">
          ...
          <div className="">
            <h5 className="text-[25px] font-bold mb-[10px]">Contact Us</h5>
            <p className="text-xl font-normal">
